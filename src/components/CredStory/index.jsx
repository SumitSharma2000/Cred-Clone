      ...
      <div className="max-width flex story-wrapper">
        ...
        <div className="cred-story-details">
          <div className="cred-story-para">
            ...
            overlooked. not just by individuals, but by entire socities. we felt
            it was time someone gave it the spotlight it deserve. especially for
            the ones who live by this virtue: the trustworthy.
          </div>
          <div className="cred-story-para">
            ...
            want one step ahead: we built it. we know we are on the right track
